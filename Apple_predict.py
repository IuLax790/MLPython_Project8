...
Apple_Stock.Close.plot(figsize=(10,10),color='r')
plt.ylabel("{} Prices".format(Apple_Stock))
plt.title("{} Price Series".format(Apple_Stock))
plt.show()
sns.displot(Apple_Stock["Close"])
sns.displot((Apple_Stock["High"]))

X = Apple_Stock.drop(["Date","Close","Adj Close","Volume"],axis=1)
